            ...
            <div class="col-md-6 col-md-offeset-6">
                ...
                <div class="row">
                    <div>
                        ...
                        <h5>添加个人分类</h5>
                        <input type="text" class="form-control" value="${blog.classify!}" id="classify" name="classify">
                    </div>
                </div>
                <!--提交按钮-->
                <div class="row">
                    <div class="col-md-6 col-md-offeset-6">
                        <button id="submit" class="btn btn-default">修改完--我要从新发布博客</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#submit').click(function () {
        ...
        $.post("/updateController", {id:${blog.id!},content: content, title: title, tag: tag, classify: classify}, function (data) {
            alert(data);
        }, 'text');
